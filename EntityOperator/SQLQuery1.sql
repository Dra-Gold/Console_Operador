...
insert into Calificacion values ('Gacha');
...
Insert Into Operador values ('ShiraYuki',4,2,5);

insert Into Caracteristicas_Operador values (1,10);
insert Into Caracteristicas_Operador values (2,4);
insert Into Caracteristicas_Operador values (2,5);